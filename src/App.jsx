...
import CVwh from './assets/image/CVwh.svg';
      ...
      <div className="contenair">       
        <div className="title">
          ...
          onMouseOut={() => setOver3(false)} alt="mail" /></a>
            <a href="https://github.com/Shark-44/Mon_CV/blob/main/MonCV-Joanny.pdf" target="_blank"><img className="icone" src={over4 ? CVwh : CV} onMouseOver={() => setOver4(true)}
